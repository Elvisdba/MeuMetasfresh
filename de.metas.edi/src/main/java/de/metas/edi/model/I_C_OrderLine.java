...
public interface I_C_OrderLine extends de.metas.handlingunits.model.I_C_OrderLine
{
	...
	// @formatter:off
	String COLUMNNAME_EDI_OrdrspLine_ID = "EDI_OrdrspLine_ID";

	void setEDI_OrdrspLine_ID (int EDI_OrdrspLine_ID);
	int getEDI_OrdrspLine_ID();

	void setEDI_OrdrspLine (I_EDI_OrdrspLine EDI_OrdrspLine);
	I_EDI_OrdrspLine getEDI_OrdrspLine();
	// @formatter:on
