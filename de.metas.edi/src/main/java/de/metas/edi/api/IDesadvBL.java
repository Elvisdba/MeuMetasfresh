...
public interface IDesadvBL extends ISingletonService
{
	 ...
	 * Notes:
	 * <ul>
	 * <li>the order and its lines are modified (their referencing/FK columns are set), but only the lines are saved! This is because we usually call this method from a C_Order modelvalidator.
	...
	/**
	 * Set the current minimum sum percentage taken {@link IDesadvDAO#retrieveMinimumSumPercentage()}.
	 *
	 * @param desadv
	 */
