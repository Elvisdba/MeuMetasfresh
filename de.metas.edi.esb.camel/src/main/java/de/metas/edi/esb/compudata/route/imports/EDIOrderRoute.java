package de.metas.edi.esb.compudata.route.imports;
...
import de.metas.edi.esb.compudata.bean.orders.EDICompudataOrdersBean;
...
public class EDIOrderRoute extends AbstractEDIRoute
{
	...
	static
	{
		EDIOrderRoute.pojoTypes.add(de.metas.edi.esb.compudata.pojo.orders.H000.class);
		EDIOrderRoute.pojoTypes.add(de.metas.edi.esb.compudata.pojo.orders.H100.class);
		EDIOrderRoute.pojoTypes.add(de.metas.edi.esb.compudata.pojo.orders.H110.class);
		EDIOrderRoute.pojoTypes.add(de.metas.edi.esb.compudata.pojo.orders.H120.class);
		EDIOrderRoute.pojoTypes.add(de.metas.edi.esb.compudata.pojo.orders.H130.class);
		EDIOrderRoute.pojoTypes.add(de.metas.edi.esb.compudata.pojo.orders.P100.class);
		EDIOrderRoute.pojoTypes.add(de.metas.edi.esb.compudata.pojo.orders.P110.class);
		EDIOrderRoute.pojoTypes.add(de.metas.edi.esb.compudata.pojo.orders.T100.class);
	}
