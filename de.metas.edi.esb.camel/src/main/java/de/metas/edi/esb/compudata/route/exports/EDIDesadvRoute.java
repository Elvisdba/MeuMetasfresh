...
import de.metas.edi.esb.compudata.bean.desadv.EDIDesadvBean;
...
public class EDIDesadvRoute extends AbstractEDIRoute
{
	...
	public static final String EP_EDI_DESADV_CONSUMER = "direct:edi.desadv.consumer";
	...
	public void configureEDIRoute(final DataFormat jaxb, final DecimalFormat decimalFormat)
	{
		...
		from(EDIDesadvRoute.EP_EDI_DESADV_CONSUMER)
				.routeId(ROUTE_ID)
				...
				.bean(EDIDesadvBean.class, EDIDesadvBean.METHOD_createEDIData)
				//
