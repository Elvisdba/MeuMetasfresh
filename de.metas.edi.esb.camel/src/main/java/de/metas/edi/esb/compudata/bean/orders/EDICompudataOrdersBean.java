package de.metas.edi.esb.compudata.bean.orders;
...
import de.metas.edi.esb.compudata.pojo.orders.H120;
import de.metas.edi.esb.compudata.pojo.orders.H130;
import de.metas.edi.esb.compudata.pojo.orders.P100;
import de.metas.edi.esb.compudata.pojo.orders.P110;
import de.metas.edi.esb.compudata.pojo.orders.T100;
...
public class EDICompudataOrdersBean
{
	...
	public List<Message> createXMLDocument(@Body final List<Object> ediLines,
			...
			@ExchangeProperty(value = EDIOrderRoute.EDI_ORDER_EDIMessageDatePattern) final String EDIMessageDatePattern,
			@ExchangeProperty(value = EDIOrderRoute.EDI_ORDER_ADClientValue) final String ADClientValue,
			@ExchangeProperty(value = EDIOrderRoute.EDI_ORDER_ADOrgID) final BigInteger ADOrgID_IGNORED,
