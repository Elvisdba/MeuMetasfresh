...
public class AD_BoilderPlate_SendToUsers extends JavaProcess
{
	...
	{
		m_from = Services.get(IUserDAO.class).retrieveUser(getCtx(), p_AD_User_ID);
		if (m_from == null)
	...
	private List<I_AD_User> getUsers()
	{
		return Services.get(IQueryBL.class)
				.createQueryBuilder(I_AD_User.class, getCtx(), getTrxName())
				.filter(new TypedSqlQueryFilter<>(p_WhereClause))
