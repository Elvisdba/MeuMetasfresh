...
public interface IOrderBL extends ISingletonService
{
	 ...
	 * <li><code>Bill_BPartner</code>'s pricing system, see {@link de.metas.bpartner.bpPartner.service.IBPartnerDAO#retrievePricingSystemId(Properties, int, boolean, String)}
